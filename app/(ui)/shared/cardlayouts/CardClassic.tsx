...
const CardClassic = ({
  ...
  return (
    <div className=" lg:w-[80%] relative overflow-hidden bg-[#f2f2f2] min-h-fit max-h-[85vh] overflow-y-scroll rounded-2xl shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] ">
      <motion.div
        ...
        >
          {cardDetails.images.profile ? (
            <motion.div
              ...
              className={` h-[45vh] relative ${" w-full"} `}
            >
              <Image
              ...
              <div className=" space-y-2">
                ...
                {cardDetails.personal.jobTitle != "" ? (
                  <motion.h1
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className=" font-medium text-xl text-gray-500 capitalize max-w-[60%] "
                  >
                    {cardDetails.personal.jobTitle}{" "}
      ...
      {callToAction && (
        ...
        >
          <button className=" pl-4  rounded-xl h-[4.2rem] flex space-x-3 items-center justify-center w-full">
            <h3
